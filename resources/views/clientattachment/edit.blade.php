            ...
            <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <a href="{{url('uploads/client/attachments/'.$attachment->img_Url) }}" target="_blank"> <img src="{{url('uploads/attachments/file.jpg') }}" style="width:100px;height:100px;" />
                        </a>
                        @else
                        <a href="{{url('uploads/client/attachments/'.$attachment->img_Url) }}" target="_blank"> <img src="{{url('uploads/client/attachments/'.$attachment->img_Url) }}" style="width:100px;height:100px;" />
                        </a>
                        @endif
                        @endif
