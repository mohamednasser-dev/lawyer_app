                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="progress">
                                    <div class="progress-bar" role="progressbar" style="width:{{$users->count()}}%" aria-valuenow="{{$cases->count()}}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.home_session_date')}}</th>
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.home_session_status')}}</th>
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.home_session_month')}}</th>
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.home_session_case_number')}}</th>
                    ...
                    <table class="table" id="sample_3">
                        <thead class="black white-text">
                            <tr>
                                ...
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.mohdar_paper_type')}}</th>
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.home_session_date')}}</th>
                                <th scope="col" class="hidden-xs center">{{trans('site_lang.home_session_case_number')}}</th>
