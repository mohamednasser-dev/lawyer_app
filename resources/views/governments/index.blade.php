...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> {{trans('site_lang.governments')}}</li>
        </ol>
    </nav>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn-primary" id="addClientModal">
                                <i class="fa fa-plus"></i>{{trans('site_lang.add_govern')}} </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="subscribers_tbl"  class="table table-bordered">
                            ...
                            <tr>
                                <th class="center">#</th>
                                <th class="center">{{trans('site_lang.gov_name')}}</th>
                                <th class="center">{{trans('site_lang.addresses')}}</th>
                            ...
                            @foreach($data as $key=> $row)
                                <tr>
                                    ...
                                    <td>{{$row->name}}</td>
                                    <td>
                                        <a href="{{route('locations.show',$row->id)}}" class="btn btn-xs btn-outline-success">
                                            <i class="fa fa-times fa fa-white"></i>&nbsp;&nbsp; {{trans('site_lang.addresses_2')}} </a>
                                    </td>
                                    <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('governments.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group{{$errors->has('name')?' has-error':''}}">
                                    <input type="text" name="name" class="form-control" id="name"
                                           placeholder="{{trans('site_lang.gov_name')}}"
                                           value="{{ old('name') }}">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#addClientModal').click(function () {
                $('#modal_title').text("{{trans('site_lang.Add_new_gov')}}");
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: "governments/destroy/" + point_id,
                    beforeSend: function () {
