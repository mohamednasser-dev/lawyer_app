                ...
                <div class="card-body">
                    <form action="{{route('subscribers.search')}}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group{{$errors->has('package_id')?' has-error':''}} col-md-4"
                            ...
                            <div class="form-group col-md-2">
                                <button class="btn btn-success"
                                        id="addSubscribersModal">{{trans('site_lang.search')}} </button>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($row->status == trans('site_lang.statusDeactive'))
                                            <a class="btn btn-sm" data-user-id="{{$row->id}}" id="change-user-status"
                                               href="{{route('subscribers.updateStatus',['type'=>'active','id'=>$row->id])}}">
                                                <span class="btn btn-danger text-bold"> {{$row->status}}</span></a>
                                        @elseif ($row->status == trans('site_lang.statusDemo'))
                                            <span class="btn btn-warning text-bold">{{$row->status}}</span>
                                        @else
                                            <a class="btn btn-sm" data-user-Id="{{$row->id}}" id="change-user-status"
                                               href="{{route('subscribers.updateStatus',['type'=>'deactive','id'=>$row->id])}}">
                                    ...
                                    <td>
                                        ...
                                        &nbsp;&nbsp;
                                        &nbsp;&nbsp;
                                        <button data-client-id="{{$row->id}}" id="editClientData"
                                                class="btn btn-xs btn-outline-primary">
                                            <i class="fa fa-edits"></i>&nbsp;&nbsp; {{trans('site_lang.edit_client')}}
                                        </button>
                                        &nbsp;&nbsp;
                                        &nbsp;&nbsp;
