                                    ...
                                    <form class="form-login" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="app" class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input :type="fieldType" class="form-control text-bold"
                                                               name="password"
                                                               placeholder="{{trans('site_lang.auth_password')}}">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <a @click="switchField"> <i class="link-icon"
                                                                                    :data-feather="iconClass"></i></a>
                                                    </div>
                                                </div>
                                                {{--                                                    </span>--}}
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block">
                                                {{trans('site_lang.auth_login_text')}} <i
    ...
    var app = new Vue({
        ...
        methods: {
            switchField() {
                ...
                this.iconClass = this.fieldType === 'password' ? 'eye' : 'eye-off';
            }
        },
    })
</script>
