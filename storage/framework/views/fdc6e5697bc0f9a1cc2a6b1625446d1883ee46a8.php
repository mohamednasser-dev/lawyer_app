                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="dropdown mb-2">
                                    ...
                                    <a href="<?php echo e(url('attachment/'.$id)); ?>"
                                       class="btn-sm btn-primary-muted"><?php echo e(trans('site_lang.home_more_options')); ?></a>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dgmevmh7hnpa/public_html/tes/resources/views/cases/case_details.blade.php ENDPATH**/ ?>