...
<br>
        <div style="text-align:center;font-size: 30px;background-color: #8E9AA2;color: white;">
            <hl class="center"><?php echo e(trans('site_lang.reports_print_month_1')); ?>&nbsp; <?php echo e($month); ?></hl>
            <hl class="center"><?php echo e(trans('site_lang.reports_print_month_2')); ?> &nbsp; <?php echo e($year); ?> </hl>
        </div>

        <div class="col-md-12 grid-margin stretch-card">
            <div class="table" id="DailyContainer">
                <table id="dailyTable" style="text-align: center;" class="table table-bordered">
...
<?php /**PATH C:\xampp\htdocs\my websites\NewT-E-S\resources\views/Reports/MonthlyPDF.blade.php ENDPATH**/ ?>